...
|**Cost**|24h: <span>\$</span>1,662.21<br />(8h: <span>\$</span>546.48)|24h: <span>\$</span>2,409.00<br />8h: <span>\$</span>803,88<br />Note: perf increase added *(2)*|24h: <span>\$</span>2,084.00<br />(8h: <span>\$</span>685.15)|24h: <span>\$</span>2,100.36<br />8h: <span>\$</span>749.43<br />+<span>\$</span>375 license cost *(3)* / mo|Depends on K8S, HDI, Databricks VMs implementation|
